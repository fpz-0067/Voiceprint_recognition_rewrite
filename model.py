...
def vggvox_model():
    ...
    # x = Conv2D(filters=1024, kernel_size=(1, 1), strides=(1, 1), padding='valid', name='fc8')(x)  # 测试

    x = Conv2D(filters=c.N_CLASS, kernel_size=(1, 1), strides=(1, 1), padding='valid',activation="softmax",name='fc8')(x)  # 训练
